...
export default {
  ...
  elmExecPath: {
    ...
    type: 'string',
    default: which.sync('elm', { nothrow: true }) || 'elm',
    order: 46,
  },
  ...
  elmTestExecPath: {
    ...
    type: 'string',
    default: which.sync('elm-test', { nothrow: true }) || 'elm-test',
    order: 47,
  },
  ...
  elmMakeExecPath: {
    ...
    type: 'string',
    default: which.sync('elm-make', { nothrow: true }) || 'elm-make',
    order: 48,
  },
  elmPackageExecPath: {
    ...
    type: 'string',
    default: which.sync('elm-package', { nothrow: true }) || 'elm-package',
    order: 49,
  },
  elmReplExecPath: {
    ...
    type: 'string',
    default: which.sync('elm-repl', { nothrow: true }) || 'elm-repl',
    order: 50,
  },
  evalPreludePath: {
